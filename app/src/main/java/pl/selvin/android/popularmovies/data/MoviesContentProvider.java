...
public class MoviesContentProvider extends AutoContentProvider {
    ...
    private final static String DATABASE_NAME = "movies_database";
    ...
    public final static ContentHelper HELPER = new ContentHelper(MoviesDatabase.class, Constants.AUTHORITY,
    ...
    public MoviesContentProvider() {
        ...
        matcher.addURI(Constants.AUTHORITY, MoviesDef.MOVIES_BULK_INSERT_WITH_RESET_FLAG + "/#", MOVIES_BULK_INSERT_WITH_RESET_FLAG);
        matcher.addURI(Constants.AUTHORITY, MovieDetailsDef.TABLE_NAME, MOVIE_DETAILS);
        matcher.addURI(Constants.AUTHORITY, ReviewsDef.TABLE_NAME, REVIEWS);
        matcher.addURI(Constants.AUTHORITY, VideosDef.TABLE_NAME, VIDEOS);
        matcher.addURI(Constants.AUTHORITY, MoviesDef.MOVIES_WITH_DETAILS, MOVIES_WITH_DETAILS);
